...
---
**The most up-to-date version of the ArrayResizer utility can be found here**: [https://github.com/Excel-DNA/ExcelDna/blob/master/Distribution/Samples/ArrayResizer.dna][array-resizer]

**To work correctly under Excel 2000/2002/2003, this sample requires at least version 0.29.0.12 of Excel-DNA**.
...
1. [Get started with Excel-DNA][getting-started].
